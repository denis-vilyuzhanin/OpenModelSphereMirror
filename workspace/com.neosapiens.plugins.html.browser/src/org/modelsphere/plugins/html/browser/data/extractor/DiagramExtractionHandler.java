 ...
 * extraction for the diagrams.
 * 
 * @version 1.0.0
 * @author Open ModelSphere HTML Reports Team
 */
public class DiagramExtractionHandler implements DataExtractionHandler
{
	/**
	 * Verify if the object can be is of the type DbSMSDiagram and can be
	 * handled.
	 * 
	 * @param dbObject
	...
	{
		SMSDiagramExtractor smsDiagramExtractor = new SMSDiagramExtractor((DbSMSDiagram) dbObject, null);
		DataDiagram diagram = smsDiagramExtractor.extractDbSMSDiagram();
