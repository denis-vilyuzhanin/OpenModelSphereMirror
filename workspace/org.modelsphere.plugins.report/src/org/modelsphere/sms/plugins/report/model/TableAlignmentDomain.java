...
public class TableAlignmentDomain extends IntDomain {
    ...
    public static final TableAlignmentDomain[] objectPossibleValues = new TableAlignmentDomain[] {
            new TableAlignmentDomain(NULL), new TableAlignmentDomain(LEFT),
            new TableAlignmentDomain(RIGHT), new TableAlignmentDomain(CENTER) };

    public static final String[] stringPossibleValues = new String[] { "",
            LocaleMgr.misc.getString("left"), LocaleMgr.misc.getString("right"),
            LocaleMgr.misc.getString("center") };

    public static TableAlignmentDomain getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected TableAlignmentDomain(int value) {
        super(value);
    }

    public final DbtAbstract duplicate() {
        return new TableAlignmentDomain(value);
    }
