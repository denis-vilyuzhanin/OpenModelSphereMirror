...
public class ReverseJavaBytecodeWizard extends Wizard<ReverseJavaBytecodeParameters> {

    public ReverseJavaBytecodeWizard(ReverseJavaBytecodeParameters params) {
        super(params);

        //added page 1 and 2
        new ReverseJavaBytecodeWizardPage1(this);
        new ReverseJavaBytecodeWizardPage2(this);
    }
}
