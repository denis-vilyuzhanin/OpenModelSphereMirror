...
public class ReverseJavaBytecodeWizardPage2 extends WizardPage {
    ...
    public ReverseJavaBytecodeWizardPage2(Wizard<ReverseJavaBytecodeParameters> wizard) {
        super(wizard);
    ...
    private void initContents() {
        ...
        //add checkbox
        createDiagramsBox = new JCheckBox(LocaleMgr.misc.getString("CreateDiagrams"));
        ...
        //add checkbox
        createFieldsBox = new JCheckBox(LocaleMgr.misc.getString("CreateFields"));
        ...
        //add checkbox
        createMethodsBox = new JCheckBox(LocaleMgr.misc.getString("CreateMethods"));
    ...
    public void beforeShowing() {
        ReverseJavaBytecodeParameters params = (ReverseJavaBytecodeParameters) getWizard()
                .getParameters();
    ...
    public void onShowing() {
        ...
        final ReverseJavaBytecodeParameters params = (ReverseJavaBytecodeParameters) getWizard()
                .getParameters();
        ...
        Thread worker = new Thread() {
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        String pattern = LocaleMgr.misc.getString("0FilesAnd1FoldersScanned");
                        String msg = MessageFormat.format(pattern, params.nbFilesScanned,
                                params.nbFoldersScanned);
                        progressLabel.setText(msg);

                        pattern = LocaleMgr.misc.getString("Found0ClassAnd1JarFiles");
                        msg = MessageFormat.format(pattern, params.nbClassFiles, params.nbJarFiles);
                        nbFilesLabel.setText(msg);

                        resultLabel.setText(LocaleMgr.misc.getString("ReadyToProceed"));
    ...
    // private
    //
    private void scanDirectory(File folder, ReverseJavaBytecodeParameters params,
    ...
    private class ScanningController extends Controller {
        ...
        ScanningController(ReverseJavaBytecodeParameters params, JLabel label1, JLabel label2,
                JLabel label3) {
            m_label1 = label1;
            m_label2 = label2;
            m_label3 = label3;
        ...
        public synchronized boolean checkPoint(int jobDone) {
            ...
            String pattern = LocaleMgr.misc.getString("Scanning0FilesA1Folders");
            String msg = MessageFormat.format(pattern, m_params.nbFilesScanned,
                    m_params.nbFoldersScanned);
            m_label1.setText(msg);

            pattern = LocaleMgr.misc.getString("Found0ClassAnd1JarFilesSoFar");
            msg = MessageFormat.format(pattern, m_params.nbClassFiles, m_params.nbJarFiles);
            m_label2.setText(msg);

            pattern = LocaleMgr.misc.getString("TotalSizeOfBytecode0KB");
