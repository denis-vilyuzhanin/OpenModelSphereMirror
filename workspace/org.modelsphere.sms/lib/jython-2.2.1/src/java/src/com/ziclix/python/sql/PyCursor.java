 ...
 *
 * $Id: PyCursor.java 3507 2007-09-22 12:07:42Z cgroves $
 *
...
public class PyCursor extends PyObject implements ClassDictInit, WarningListener {
  ...
  static public void classDictInit(PyObject dict) {
    ...
    dict.__setitem__("__version__", Py.newString("$Revision: 3507 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
