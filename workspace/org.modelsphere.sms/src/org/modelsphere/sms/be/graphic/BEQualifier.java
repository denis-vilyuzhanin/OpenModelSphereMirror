...
public class BEQualifier extends SrAttachment {

    public BEQualifier(Diagram diag, GraphicNode node, MetaField offsetMF, ArrayList qualifiers)
            throws DbException {
        super(diag, node, offsetMF);
