...
public class BEStamp extends Stamp implements DbRefreshListener {
    ...
    // LOCALIZABLE,
    // property key
    private static String END_ZONE_ID = "Stamp End Zone"; // NOT LOCALIZABLE,
    // property key
    ...
    // LOCALIZABLE
    private MatrixZone headerZone = new MatrixZone(HEADER_ZONE_ID, GraphicUtil.LEFT_ALIGNMENT);
    private MatrixZone middleZone = new MatrixZone(MIDDLE_ZONE_ID, GraphicUtil.LEFT_ALIGNMENT);
    private MatrixZone endZone = new MatrixZone(END_ZONE_ID, GraphicUtil.LEFT_ALIGNMENT);
    private MatrixZone descriptionZone = new MatrixZone(DESC_ZONE_ID, GraphicUtil.LEFT_ALIGNMENT);
    ...
    public BEStamp(Diagram diag, DbObject BEStampGo) throws DbException {
        super(diag, BEStampGo);
        ...
        thePackage = (DbSMSPackage) theStampGo.getComposite().getCompositeOfType(
    ...
    private final void buildDescriptionZone() {
        ...
        descriptionZone.addColumn(new ColumnCellsOption(CRO_Label, descriptionCellEditor, false));
