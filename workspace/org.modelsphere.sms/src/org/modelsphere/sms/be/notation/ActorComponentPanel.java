...
public final class ActorComponentPanel extends JPanel implements ActionListener, ComponentTestable {
    ...
    public ActorComponentPanel() {
        initGUI();
    }

    public ActorComponentPanel(OptionComponent optionComponent) {
    ...
    private void initGUI() {
        ...
        add(zoneEditor, new GridBagConstraints(0, 2, 5, 1, 1.0, 1.0, GridBagConstraints.WEST,
                GridBagConstraints.BOTH, new Insets(6, 12, 6, 12), 0, 0));
    ...
    void initFields(DbBENotation notation, Object[] values) throws DbException {
        init = true; // avoid setText to trigger a value changed
        ...
        // LOCALIZABLE
        zoneEditor.initValues(notation, BEZoneStereotype.getInstance(BEZoneStereotype.ACTOR));
        if (values[3] != null) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == shape) {
            ...
            SMSNotationShape shape = SMSNotationShape.objectPossibleValues[idx];
            optionComponent.setValue(shape, 3);
        }
    }

    public JComponent createOccurrence() {
        Application.initMeta();
        JPanel panel = new ActorComponentPanel(optionComponent);
        return panel;
    }
    ...
    public static void main(String[] args) {
        // init meta
        Application.initMeta();
        org.modelsphere.jack.baseDb.db.Db db = org.modelsphere.jack.srtool.ApplicationContext
                .getDbRepos();
        org.modelsphere.jack.baseDb.db.DbRoot root = db.getRoot();

        // init notation
        // org.modelsphere.jack.baseDb.db.DbProject proj = new
        // org.modelsphere.jack.baseDb.db.DbProject(db);
        // org.modelsphere.sms.notation.NotationFrame f =
        // NotationFrame.showNotationFrame(proj);

        org.modelsphere.sms.notation.NotationComponent notation = null;
        org.modelsphere.jack.baseDb.meta.MetaField[] metaFields = new org.modelsphere.jack.baseDb.meta.MetaField[] {};
        OptionComponent optionComponent = new ActorComponent(notation, metaFields);
