...
public class StoreComponent extends OptionComponent {
    public StoreComponent(NotationComponent NotationComponent, MetaField[] metaFields) {
        super(NotationComponent, metaFields);
        optionPanel = new StoreComponentPanel(this);
    }
    ...
    private void initFields() throws DbException {
        ((StoreComponentPanel) optionPanel).initFields((DbBENotation) notation, values);
    }
