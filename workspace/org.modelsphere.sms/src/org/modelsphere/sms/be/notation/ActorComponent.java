...
public class ActorComponent extends OptionComponent {
    public ActorComponent(NotationComponent NotationComponent, MetaField[] metaFields) {
        super(NotationComponent, metaFields);
        optionPanel = new ActorComponentPanel(this);
    }
    ...
    private void initFields() throws DbException {
        ((ActorComponentPanel) optionPanel).initFields((DbBENotation) notation, values);
    }
