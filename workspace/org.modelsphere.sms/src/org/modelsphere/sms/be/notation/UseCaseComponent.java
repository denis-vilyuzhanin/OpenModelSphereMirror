...
public class UseCaseComponent extends OptionComponent {
    public UseCaseComponent(NotationComponent NotationComponent, MetaField[] metaFields) {
        super(NotationComponent, metaFields);
        optionPanel = new UseCaseComponentPanel(this);
    }
    ...
    private void initFields() throws DbException {
        ((UseCaseComponentPanel) optionPanel).initFields((DbBENotation) notation, values);
    }
