 ...
 * 
 * <b>Composites : </b><A
 * HREF="../../../../../org/modelsphere/sms/be/db/DbBEActor.html">DbBEActor</A>.<br>
 * <b>Components : </b>none.<br>
 **/
public final class DbBEActorQualifier extends DbBEQualifierLink {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbBEActorQualifier"), DbBEActorQualifier.class,
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setIcon("dbbeactorqualifier.gif");

            fQualifier.setJField(DbBEActorQualifier.class.getDeclaredField("m_qualifier"));
            ...
            fQualifier.setOppositeRel(DbBEQualifier.fQualifiedActors);
     ...
     **/
    public DbBEActorQualifier(DbObject composite, DbSMSSemanticalObject semObj) throws DbException {
        super(composite);
