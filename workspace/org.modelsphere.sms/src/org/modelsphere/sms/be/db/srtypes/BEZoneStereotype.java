...
public class BEZoneStereotype extends IntDomain {
    ...
    public static final BEZoneStereotype[] objectPossibleValues = new BEZoneStereotype[] {
            new BEZoneStereotype(ACTOR), new BEZoneStereotype(FLOW), new BEZoneStereotype(USECASE),
            new BEZoneStereotype(STORE) };

    public static BEZoneStereotype getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected BEZoneStereotype(int value) {
        super(value);
    }

    //Parameterless constructor
    public BEZoneStereotype() {
    }

    public final DbtAbstract duplicate() {
        return new BEZoneStereotype(value);
    }
    ...
    public final String[] getStringPossibleValues() {
        String[] stringPossibleValues = new String[] { DbBEActor.metaClass.getGUIName(),
                DbBEFlow.metaClass.getGUIName(), DbBEUseCase.metaClass.getGUIName(),
                DbBEStore.metaClass.getGUIName() };
