 ...
 **/
public final class DbBEFlowQualifier extends DbBEQualifierLink {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbBEFlowQualifier"), DbBEFlowQualifier.class,
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setIcon("dbbeflowqualifier.gif");

            fQualifier.setJField(DbBEFlowQualifier.class.getDeclaredField("m_qualifier"));
            ...
            fQualifier.setOppositeRel(DbBEQualifier.fQualifiedFlows);
     ...
     **/
    public DbBEFlowQualifier(DbObject composite, DbSMSSemanticalObject semObj) throws DbException {
        super(composite);
