...
public class BEDiscreteContinous extends IntDomain {
    ...
    public static final BEDiscreteContinous[] objectPossibleValues = new BEDiscreteContinous[] {
            new BEDiscreteContinous(DISCRETE), new BEDiscreteContinous(CONTINOUS) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("discrete"), LocaleMgr.misc.getString("continous") };

    public static BEDiscreteContinous getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected BEDiscreteContinous(int value) {
        super(value);
    }

    //Parameterless constructor
    public BEDiscreteContinous() {
    }

    public final DbtAbstract duplicate() {
        return new BEDiscreteContinous(value);
    }
