 ...
 **/
public final class DbBEUseCaseGo extends DbSMSClassifierGo {
    ...
    public static final MetaClass metaClass = new MetaClass(
            LocaleMgr.db.getString("DbBEUseCaseGo"), DbBEUseCaseGo.class, new MetaField[] {
                    fQualifiersOffset, fCell }, MetaClass.NO_UDF);
    ...
    public static void initMeta() {
        try {
            ...
            fQualifiersOffset.setJField(DbBEUseCaseGo.class.getDeclaredField("m_qualifiersOffset"));
            fCell.setJField(DbBEUseCaseGo.class.getDeclaredField("m_cell"));

            fCell.setOppositeRel(DbBEContextCell.fUsecaseGos);
     ...
     **/
    public DbBEUseCaseGo(DbSMSDiagram composite, DbSMSClassifier classifier) throws DbException {
    ...
    private void setDefaultInitialValues() throws DbException {
        ...
        newRect.setSize(notation.getUseCaseDefaultWidth().intValue(), notation
                .getUseCaseDefaultHeight().intValue());
