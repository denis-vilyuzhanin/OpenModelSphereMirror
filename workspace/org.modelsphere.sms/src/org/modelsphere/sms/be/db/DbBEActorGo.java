 ...
 **/
public final class DbBEActorGo extends DbSMSClassifierGo {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbBEActorGo"),
            DbBEActorGo.class, new MetaField[] { fQualifiersOffset, fCell }, MetaClass.NO_UDF);
    ...
    public static void initMeta() {
        try {
            ...
            fQualifiersOffset.setJField(DbBEActorGo.class.getDeclaredField("m_qualifiersOffset"));
            fCell.setJField(DbBEActorGo.class.getDeclaredField("m_cell"));

            fCell.setOppositeRel(DbBEContextCell.fActorGos);
     ...
     **/
    public DbBEActorGo(DbSMSDiagram composite, DbSMSClassifier classifier) throws DbException {
    ...
    private void setDefaultInitialValues() throws DbException {
        ...
        newRect.setSize(notation.getActorDefaultWidth().intValue(), notation
                .getActorDefaultHeight().intValue());
