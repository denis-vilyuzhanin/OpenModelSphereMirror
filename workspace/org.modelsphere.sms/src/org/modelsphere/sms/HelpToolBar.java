...
public class HelpToolBar extends JackToolBar {

    private JButton buttonHelp;

    public HelpToolBar() {
        SMSActionsStore actionsStore = SMSActionsStore.getSingleton();
        buttonHelp = addFormated(actionsStore.getAction(SMSActionsStore.HELP_SHOW));
        setName(LocaleMgr.misc.getString("HelpToolBarName"));
    }
