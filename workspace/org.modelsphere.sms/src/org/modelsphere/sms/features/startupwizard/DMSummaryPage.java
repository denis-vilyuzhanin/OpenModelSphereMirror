...
class DMSummaryPage extends AbstractPage {

    private StartupWizardModel model = null;
    private JPanel iconsPanel = new JPanel();

    DMSummaryPage(StartupWizardModel model) {
    ...
    public void load() throws DbException {
        ...
        StartupWizardUtilities.displayAvailableTools(model, iconsPanel, DbGEDataModel.metaClass);
