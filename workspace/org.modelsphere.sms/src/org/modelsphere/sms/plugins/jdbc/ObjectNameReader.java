...
package org.modelsphere.sms.plugins.jdbc; //org.modelsphere.jack.srtool.reverse;
...
public final class ObjectNameReader implements InputReadable {
    ...
    class InputFileParserStream extends LexerStream {
        ...
        private boolean isTextAttr(String word) {
            String[] keywords = new String[] { "comments", "oid_text", "view_text", "data_default",
                    "search", "part_value", "description", "trig_body", "text" };
     ...
     * File("y.txt"); FileInputStream istream = new FileInputStream(file); InputStreamReader ireader
     * = new InputStreamReader(istream); BufferedReader bufReader = new BufferedReader(ireader);
     * parser.readInputFile(bufReader); } catch (Exception ex) {
