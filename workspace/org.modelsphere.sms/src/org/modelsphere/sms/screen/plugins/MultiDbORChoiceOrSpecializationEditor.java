...
public class MultiDbORChoiceOrSpecializationEditor extends MultiDbSemanticalObjectEditor {

    protected DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        MetaClass mc = DbORChoiceOrSpecialization.metaClass; 
        return parentDbo.getCompositeOfType(DbORDataModel.metaClass).getComponents().elements(
                mc);
    }
