...
public class MultiDbJVCompilationUnitEditor extends MultiDbSemanticalObjectEditor {

    protected final DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        return parentDbo.getComposite().getComponents().elements(DbJVCompilationUnit.metaClass);
    }
