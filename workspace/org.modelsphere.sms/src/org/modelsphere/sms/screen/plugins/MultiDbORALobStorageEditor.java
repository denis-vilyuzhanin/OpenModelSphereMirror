...
public class MultiDbORALobStorageEditor extends MultiDbSemanticalObjectEditor {

    protected DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        // return
        // parentDbo.getCompositeOfType(DbORATable.metaClass).getComponents().elements(DbORALobStorage.metaClass);
        return parentDbo.getCompositeOfType(DbORAbsTable.metaClass).getComponents().elements(
                DbORALobStorage.metaClass);
    }
