...
public class DbBEQualifierEditor extends DbSemanticalObjectEditor {

    protected DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        return parentDbo.getCompositeOfType(DbBEModel.metaClass).getComponents().elements(
                DbBEQualifier.metaClass);
    }
}
