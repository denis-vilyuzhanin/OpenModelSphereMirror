...
public class DbORChoiceOrSpecializationEditor extends DbSemanticalObjectEditor {
    ...
    protected DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        ...
        DbEnumeration enu = parentDbo.getCompositeOfType(DbORDataModel.metaClass).getComponents()
                .elements(mc);
        return enu;
    }
