...
public class MultiDbIBMDbPartitionGroupEditor extends MultiDbSemanticalObjectEditor {

    protected DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        DbIBMDatabase db = (DbIBMDatabase) parentDbo.getCompositeOfType(DbIBMDatabase.metaClass);
        DbEnumeration dbEnum = db.getComponents().elements(DbIBMDbPartitionGroup.metaClass);
        return dbEnum;
    }
