...
public class MultiDbORPrimaryUniqueEditor extends MultiDbSemanticalObjectEditor {

    protected final DbEnumeration getSelectionEnum(DbObject parentDbo) throws DbException {
        return ((DbORAssociationEnd) parentDbo).getOppositeEnd().getClassifier().getComponents()
                .elements(DbORPrimaryUnique.metaClass);
    }
