 ...
 * 
 */
public final class MultiSMSSemanticalMetaClassRenderer extends MultiDefaultRenderer {
    public static final MultiSMSSemanticalMetaClassRenderer singleton = new MultiSMSSemanticalMetaClassRenderer();
    private static final String APPLICABLE_ON = LocaleMgr.db.getString("metaClassName");
    ...
    protected String getDisplayedValue(JTable table, Object value, int row, int col) {
        ...
        if (text.length() > 0) {
            setText(text);
            String toolTipText = "<html><b>" + APPLICABLE_ON + "</b><br>" + text + "</html>";
