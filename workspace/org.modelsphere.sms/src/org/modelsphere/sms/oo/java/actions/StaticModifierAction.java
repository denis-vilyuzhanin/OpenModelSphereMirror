...
public class StaticModifierAction extends AbstractTriStatesAction
		implements
			SelectionActionListener {

	StaticModifierAction() {
		super(LocaleMgr.action.getString("Static"), LocaleMgr.action
				.getImageIcon("Static"));
		setVisible(ScreenPerspective.isFullVersion());
	}

	protected final void doActionPerformed() {
		performTriState(ApplicationContext.getFocusManager()
				.getSelectedSemanticalObjects(), LocaleMgr.action
				.getString("StaticModifierUpdate"));
	}

	public final void updateSelectionAction() throws DbException {
		updateTriState(ApplicationContext.getFocusManager()
	...
	protected final void setObjectValue(Object obj, Boolean value)
			throws DbException {
		DbObject semObj = (DbObject) obj;
		MetaField field = getMetaField(semObj);
		if (field != null)
