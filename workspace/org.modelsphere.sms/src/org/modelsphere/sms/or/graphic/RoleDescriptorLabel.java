...
public class RoleDescriptorLabel extends SrLineLabel {
    public RoleDescriptorLabel(Diagram diag, DbObject semObj, ORAssociation newOrAssociation,
            MetaField offsetMF) throws DbException {
        super(diag, semObj, newOrAssociation, offsetMF, "");
    }
