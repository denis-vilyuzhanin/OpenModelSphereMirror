...
public class ORAInvokerRights extends IntDomain {
    ...
    public static final ORAInvokerRights[] objectPossibleValues = new ORAInvokerRights[] {
            new ORAInvokerRights(CURRENTUSER), new ORAInvokerRights(DEFINER) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("currentuser"), LocaleMgr.misc.getString("definer") };

    public static ORAInvokerRights getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAInvokerRights(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAInvokerRights() {
    }

    public final DbtAbstract duplicate() {
        return new ORAInvokerRights(value);
    }
