...
public final class ORAOperationLibraryToolkit extends SMSToolkit {
    ...
    protected MetaClass[] getSupportedPackage() {
        return new MetaClass[] { DbORAProgramUnitLibrary.metaClass };
    }
    ...
    public DbObject createDbObject(MetaClass abstractMetaClass, DbObject composite,
        ...
        if (composite != null) {
            if (abstractMetaClass.equals(DbORProcedure.metaClass))
                return composite.createComponent(DbORAProcedure.metaClass);
            if (abstractMetaClass.equals(DbORParameter.metaClass))
                return composite.createComponent(DbORAParameter.metaClass);
        }
        return null;
    }
