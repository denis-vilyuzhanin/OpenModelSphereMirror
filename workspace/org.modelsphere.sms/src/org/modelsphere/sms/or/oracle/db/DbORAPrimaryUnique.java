 ...
 **/
public final class DbORAPrimaryUnique extends DbORPrimaryUnique {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbORAPrimaryUnique"), DbORAPrimaryUnique.class, new MetaField[] {
            fChecking, fDeferrable, fEnabled, fValidated, fExceptionTable }, MetaClass.MATCHABLE);
    ...
    public static void initMeta() {
        try {
            metaClass.setSuperMetaClass(DbORPrimaryUnique.metaClass);

            fChecking.setJField(DbORAPrimaryUnique.class.getDeclaredField("m_checking"));
            fDeferrable.setJField(DbORAPrimaryUnique.class.getDeclaredField("m_deferrable"));
            fEnabled.setJField(DbORAPrimaryUnique.class.getDeclaredField("m_enabled"));
            fValidated.setJField(DbORAPrimaryUnique.class.getDeclaredField("m_validated"));
            fExceptionTable
                    .setJField(DbORAPrimaryUnique.class.getDeclaredField("m_exceptionTable"));
            fExceptionTable.setRendererPluginName("DbORTable");

            fExceptionTable.setOppositeRel(DbORATable.fPrimaryUniqueConstraints);
     ...
     **/
    public DbORAPrimaryUnique(DbObject composite) throws DbException {
        super(composite);
 ...
 **/
    ...
    /**
     * Gets the "deferrable" property's Boolean value of a DbORAPrimaryUnique's instance.
     * 
