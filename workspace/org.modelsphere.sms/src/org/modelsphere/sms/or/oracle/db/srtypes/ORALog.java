...
public class ORALog extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int LOGGING = 1;
    public static final int NOLOGGING = 2;

    public static final ORALog[] objectPossibleValues = new ORALog[] { new ORALog(LOGGING),
            new ORALog(NOLOGGING) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("logging"), LocaleMgr.misc.getString("nologging") };

    public static ORALog getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORALog(int value) {
        super(value);
    }
