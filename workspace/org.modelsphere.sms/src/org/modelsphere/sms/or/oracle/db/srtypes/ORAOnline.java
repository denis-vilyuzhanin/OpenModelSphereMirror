...
public class ORAOnline extends IntDomain {
    ...
    public static final ORAOnline[] objectPossibleValues = new ORAOnline[] { new ORAOnline(ONLINE),
            new ORAOnline(OFFLINE) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("online"), LocaleMgr.misc.getString("offline") };

    public static ORAOnline getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAOnline(int value) {
        super(value);
    }
