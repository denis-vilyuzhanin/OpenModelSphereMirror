...
public class INFProcedureVariant extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int VARIANT = 1;
    public static final int NOT_VARIANT = 2;

    public static final INFProcedureVariant[] objectPossibleValues = new INFProcedureVariant[] {
            new INFProcedureVariant(VARIANT), new INFProcedureVariant(NOT_VARIANT) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("variant"), LocaleMgr.misc.getString("notvariant") };

    public static INFProcedureVariant getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected INFProcedureVariant(int value) {
        super(value);
    }

    //Parameterless constructor
    public INFProcedureVariant() {
    }

    public final DbtAbstract duplicate() {
        return new INFProcedureVariant(value);
    }
