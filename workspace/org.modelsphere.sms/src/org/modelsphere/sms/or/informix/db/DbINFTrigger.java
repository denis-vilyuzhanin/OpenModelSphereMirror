 ...
 **/
public final class DbINFTrigger extends DbORTrigger {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbINFTrigger"),
            DbINFTrigger.class, new MetaField[] {}, MetaClass.MATCHABLE);
     ...
     **/
    public DbINFTrigger(DbObject composite) throws DbException {
        super(composite);
