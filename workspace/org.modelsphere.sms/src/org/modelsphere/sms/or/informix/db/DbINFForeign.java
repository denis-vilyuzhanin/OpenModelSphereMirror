 ...
 **/
public final class DbINFForeign extends DbORForeign {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbINFForeign"),
            DbINFForeign.class, new MetaField[] { fMode, fUser }, MetaClass.MATCHABLE);
    ...
    public static void initMeta() {
        try {
            ...
            fMode.setJField(DbINFForeign.class.getDeclaredField("m_mode"));
            fUser.setJField(DbINFForeign.class.getDeclaredField("m_user"));
            fUser.setFlags(MetaField.COPY_REFS);

            fUser.setOppositeRel(DbORUser.fForeignKeys);
     ...
     **/
    public DbINFForeign(DbORAssociationEnd assocEnd) throws DbException {
        super(assocEnd);
