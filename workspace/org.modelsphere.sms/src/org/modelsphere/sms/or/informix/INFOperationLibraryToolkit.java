...
public final class INFOperationLibraryToolkit extends SMSToolkit {
    ...
    protected MetaClass[] getSupportedPackage() {
        return new MetaClass[] { DbINFOperationLibrary.metaClass };
    }
    ...
    public DbObject createDbObject(MetaClass abstractMetaClass, DbObject composite,
        ...
        if (composite != null) {
            if (abstractMetaClass.equals(DbORProcedure.metaClass))
                return composite.createComponent(DbINFProcedure.metaClass);
            if (abstractMetaClass.equals(DbORParameter.metaClass))
                return composite.createComponent(DbINFParameter.metaClass);
        }
        return null;
    }
