 ...
 **/
public final class DbINFOperationLibrary extends DbOROperationLibrary {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbINFOperationLibrary"), DbINFOperationLibrary.class, new MetaField[] {},
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbINFProcedure.metaClass });
     ...
     **/
    public DbINFOperationLibrary(DbObject composite, DbSMSTargetSystem targetSystem)
            throws DbException {
