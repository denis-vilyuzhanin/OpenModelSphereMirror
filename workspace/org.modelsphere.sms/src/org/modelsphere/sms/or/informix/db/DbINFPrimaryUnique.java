 ...
 **/
public final class DbINFPrimaryUnique extends DbORPrimaryUnique {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbINFPrimaryUnique"), DbINFPrimaryUnique.class, new MetaField[] { fMode,
            fUser }, MetaClass.MATCHABLE);
    ...
    public static void initMeta() {
        try {
            ...
            fMode.setJField(DbINFPrimaryUnique.class.getDeclaredField("m_mode"));
            fUser.setJField(DbINFPrimaryUnique.class.getDeclaredField("m_user"));
            fUser.setFlags(MetaField.COPY_REFS);

            fUser.setOppositeRel(DbORUser.fPrimaryUniqueKeys);
     ...
     **/
    public DbINFPrimaryUnique(DbObject composite) throws DbException {
        super(composite);
