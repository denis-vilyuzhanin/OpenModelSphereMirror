...
public class INFTriggerObjectMode extends IntDomain {
    ...
    public static final INFTriggerObjectMode[] objectPossibleValues = new INFTriggerObjectMode[] {
            new INFTriggerObjectMode(ENABLED), new INFTriggerObjectMode(DISABLED) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("enabled"), LocaleMgr.misc.getString("disabled") };

    public static INFTriggerObjectMode getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected INFTriggerObjectMode(int value) {
        super(value);
    }

    //Parameterless constructor
    public INFTriggerObjectMode() {
    }

    public final DbtAbstract duplicate() {
        return new INFTriggerObjectMode(value);
    }
