 ...
 **/
public final class DbORAssociationGo extends DbSMSAssociationGo {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbORAssociationGo"), DbORAssociationGo.class, new MetaField[] {},
            MetaClass.NO_UDF);
     ...
     **/
    public DbORAssociationGo(DbSMSDiagram composite, DbSMSGraphicalObject frontEndGo,
