 ...
 **/
public final class DbGETrigger extends DbORTrigger {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGETrigger"),
            DbGETrigger.class, new MetaField[] {}, MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGETrigger.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGETrigger(DbObject composite) throws DbException {
        super(composite);
