 ...
 * <b>Components : </b><A
 * HREF="../../../../../../org/modelsphere/sms/or/generic/db/DbGETable.html">DbGETable</A>, <A
 * HREF="../../../../../../org/modelsphere/sms/or/generic/db/DbGEView.html">DbGEView</A>, <A
 ...
 **/
public final class DbGEDataModel extends DbORDataModel {

    //Meta

    public static final MetaClass metaClass = new MetaClass(
            LocaleMgr.db.getString("DbGEDataModel"), DbGEDataModel.class, new MetaField[] {},
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbGETable.metaClass,
                    DbGEView.metaClass });
     ...
     **/
    public DbGEDataModel() {
    }

    /**
     * Creates an instance of DbGEDataModel.
     * 
     * @param composite
     ...
     **/
    public DbGEDataModel(DbObject composite, DbSMSTargetSystem targetSystem) throws DbException {
     ...
     *            int
     **/
    public DbGEDataModel(DbObject composite, DbSMSTargetSystem targetSystem, int logicalMode)
            throws DbException {
