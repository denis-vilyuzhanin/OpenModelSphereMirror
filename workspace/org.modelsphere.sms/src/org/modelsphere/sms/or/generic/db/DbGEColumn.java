 ...
 **/
public final class DbGEColumn extends DbORColumn {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGEColumn"),
            DbGEColumn.class, new MetaField[] {}, MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGEColumn.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGEColumn(DbObject composite) throws DbException {
        super(composite);
