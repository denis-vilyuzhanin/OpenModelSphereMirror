 ...
 * <b>Components : </b><A
 * HREF="../../../../../../org/modelsphere/sms/or/generic/db/DbGEParameter.html">DbGEParameter</A>,
 * <A HREF="../../../../../../org/modelsphere/sms/db/DbSMSObjectImport.html">DbSMSObjectImport</A>.<br>
 **/
public final class DbGEProcedure extends DbORProcedure {

    //Meta

    public static final MetaClass metaClass = new MetaClass(
            LocaleMgr.db.getString("DbGEProcedure"), DbGEProcedure.class, new MetaField[] {},
            MetaClass.MATCHABLE);
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbGEParameter.metaClass });
     ...
     **/
    public DbGEProcedure() {
    }

    /**
     * Creates an instance of DbGEProcedure.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGEProcedure(DbObject composite) throws DbException {
        super(composite);
