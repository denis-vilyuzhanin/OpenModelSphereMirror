 ...
 **/
public final class DbGEIndex extends DbORIndex {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGEIndex"),
            DbGEIndex.class, new MetaField[] {}, MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGEIndex.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGEIndex(DbObject composite) throws DbException {
        super(composite);
