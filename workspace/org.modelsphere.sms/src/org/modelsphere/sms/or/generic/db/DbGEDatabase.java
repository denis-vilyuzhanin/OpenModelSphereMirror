 ...
 **/
public final class DbGEDatabase extends DbORDatabase {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGEDatabase"),
            DbGEDatabase.class, new MetaField[] {}, MetaClass.ACCESS_CTL | MetaClass.CLUSTER_ROOT
                    | MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGEDatabase.
     * 
     * @param composite
     ...
     **/
    public DbGEDatabase(DbObject composite, DbSMSTargetSystem targetSystem) throws DbException {
