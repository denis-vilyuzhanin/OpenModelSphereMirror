 ...
 **/
public final class DbGEPrimaryUnique extends DbORPrimaryUnique {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbGEPrimaryUnique"), DbGEPrimaryUnique.class, new MetaField[] {},
            MetaClass.MATCHABLE);
     ...
     **/
    public DbGEPrimaryUnique() {
    }

    /**
     * Creates an instance of DbGEPrimaryUnique.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGEPrimaryUnique(DbObject composite) throws DbException {
        super(composite);
