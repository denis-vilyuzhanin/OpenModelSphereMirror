...
public final class IBMOperationLibraryToolkit extends SMSToolkit {
    ...
    protected MetaClass[] getSupportedPackage() {
        return new MetaClass[] { DbIBMOperationLibrary.metaClass };
    }
    ...
    public DbObject createDbObject(MetaClass abstractMetaClass, DbObject composite,
        ...
        if (composite != null) {
            if (abstractMetaClass.equals(DbORProcedure.metaClass))
                return composite.createComponent(DbIBMProcedure.metaClass);
            if (abstractMetaClass.equals(DbORParameter.metaClass))
                return composite.createComponent(DbIBMParameter.metaClass);
        }
        return null;
    }
