 ...
 **/
public final class DbIBMPrimaryUnique extends DbORPrimaryUnique {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbIBMPrimaryUnique"), DbIBMPrimaryUnique.class, new MetaField[] {},
            MetaClass.MATCHABLE);
     ...
     **/
    public DbIBMPrimaryUnique(DbObject composite) throws DbException {
        super(composite);
