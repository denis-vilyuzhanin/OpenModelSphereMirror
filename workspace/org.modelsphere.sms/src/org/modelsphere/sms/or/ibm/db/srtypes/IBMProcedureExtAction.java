...
public class IBMProcedureExtAction extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int EXTERNAL_ACTION = 1;
    public static final int NO_EXTERNAL_ACTION = 2;

    protected IBMProcedureExtAction(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMProcedureExtAction(value);
    }

    public static final String[] stringPossibleValues = new String[] { "",
            LocaleMgr.misc.getString("ExternalAction"),
            LocaleMgr.misc.getString("NoExternalAction"), };

    public static final IBMProcedureExtAction[] objectPossibleValues = new IBMProcedureExtAction[] {
            new IBMProcedureExtAction(0), new IBMProcedureExtAction(EXTERNAL_ACTION),
            new IBMProcedureExtAction(NO_EXTERNAL_ACTION),
