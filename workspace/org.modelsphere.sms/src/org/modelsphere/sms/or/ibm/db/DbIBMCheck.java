 ...
 **/
public final class DbIBMCheck extends DbORCheck {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbIBMCheck"),
            DbIBMCheck.class, new MetaField[] { fEnforced, fEnableQueryOptimization },
            MetaClass.MATCHABLE);
    ...
    public static void initMeta() {
        try {
            ...
            fEnforced.setJField(DbIBMCheck.class.getDeclaredField("m_enforced"));
            fEnableQueryOptimization.setJField(DbIBMCheck.class
     ...
     **/
    public DbIBMCheck(DbObject composite) throws DbException {
        super(composite);
