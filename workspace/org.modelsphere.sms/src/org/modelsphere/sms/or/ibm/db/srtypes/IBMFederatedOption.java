...
public class IBMFederatedOption extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int FEDERATED = 1;
    public static final int NOT_FEDERATED = 2;

    protected IBMFederatedOption(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMFederatedOption(value);
    }

    public static final String[] stringPossibleValues = new String[] { "",
            LocaleMgr.misc.getString("Federated"), LocaleMgr.misc.getString("NotFederated"), };

    public static final IBMFederatedOption[] objectPossibleValues = new IBMFederatedOption[] {
            new IBMFederatedOption(0), new IBMFederatedOption(FEDERATED),
            new IBMFederatedOption(NOT_FEDERATED), };
