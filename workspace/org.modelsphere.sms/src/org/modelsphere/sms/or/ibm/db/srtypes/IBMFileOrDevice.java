...
public class IBMFileOrDevice extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int FILE = 0;
    public static final int DEVICE = 1;

    protected IBMFileOrDevice(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMFileOrDevice(value);
    }

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("file"), LocaleMgr.misc.getString("device") };

    public static final IBMFileOrDevice[] objectPossibleValues = new IBMFileOrDevice[] {
            new IBMFileOrDevice(FILE), new IBMFileOrDevice(DEVICE) };
