...
public class IBMProcedureDbInfo extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int NO_DB_INFO = 1;
    public static final int DB_INFO = 2;

    protected IBMProcedureDbInfo(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMProcedureDbInfo(value);
    }

    public static final String[] stringPossibleValues = new String[] { "",
            LocaleMgr.misc.getString("NoDbInfo"), LocaleMgr.misc.getString("DbInfo"), };

    public static final IBMProcedureDbInfo[] objectPossibleValues = new IBMProcedureDbInfo[] {
            new IBMProcedureDbInfo(0), new IBMProcedureDbInfo(NO_DB_INFO),
            new IBMProcedureDbInfo(DB_INFO),
