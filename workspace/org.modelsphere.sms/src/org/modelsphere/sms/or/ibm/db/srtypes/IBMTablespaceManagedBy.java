...
public class IBMTablespaceManagedBy extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int SYSTEM = 0;
    public static final int DATABASE = 1;

    protected IBMTablespaceManagedBy(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMTablespaceManagedBy(value);
    }

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("system"), LocaleMgr.misc.getString("database"), };

    public static final IBMTablespaceManagedBy[] objectPossibleValues = new IBMTablespaceManagedBy[] {
            new IBMTablespaceManagedBy(SYSTEM), new IBMTablespaceManagedBy(DATABASE), };
