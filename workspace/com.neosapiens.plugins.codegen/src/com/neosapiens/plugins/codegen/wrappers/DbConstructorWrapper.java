...
public class DbConstructorWrapper extends DbObjectWrapper {
    private DbJVConstructor m_constr;

    public DbConstructorWrapper(DbJVConstructor constr) {
        m_constr = constr;
    }

    public List<String> getJavaVisibility() throws DbException {
        List<String> list = new ArrayList<String>();
        JVVisibility visib = (JVVisibility) m_constr.getVisibility();
    ...
    public List<String> getParameters() throws DbException {
        ...
        List<String> list = new ArrayList<String>();
        DbRelationN relN = m_constr.getComponents();
    ...
    public List<String> getExceptions() throws DbException {
        List<String> list = new ArrayList<String>();
        DbRelationN relN = m_constr.getJavaExceptions();
