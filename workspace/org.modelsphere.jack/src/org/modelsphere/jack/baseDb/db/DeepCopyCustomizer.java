...
/**
 * Defines an interface to apply customisation operations when of each copied instance when
 * DeepCopy.copy() is called.
 * 
 * @see org.modelsphere.jack.baseDb.db.DeepCopy
 * 
 */
public interface DeepCopyCustomizer {

    public MetaClass getDestMetaClass(DbObject srcObj, DbObject destComposite) throws DbException;
