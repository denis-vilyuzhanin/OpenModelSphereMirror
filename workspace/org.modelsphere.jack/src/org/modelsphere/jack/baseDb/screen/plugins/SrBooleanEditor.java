...
public class SrBooleanEditor extends JComboBox implements Editor {
    ...
    public final Component getTableCellEditorComponent(ScreenView screenView,
            ...
            int row, int column) {
        for (int i = 0; i < SrBooleanRenderer.strings.length; i++)
            addItem(SrBooleanRenderer.strings[i]);
        setMaximumRowCount(SrBooleanRenderer.strings.length);
    ...
    public final Object getCellEditorValue() {
        return SrBooleanRenderer.values[getSelectedIndex()];
    }
