...
public class MultiSrImageRenderer extends MultiDefaultRenderer {
    public static final MultiSrImageRenderer singleton = new MultiSrImageRenderer();

    protected MultiSrImageRenderer() {
    }
