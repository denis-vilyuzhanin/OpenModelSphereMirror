...
public class MultiDbSemObjFullNameRenderer extends MultiDefaultRenderer {

    public static final MultiDbSemObjFullNameRenderer singleton = new MultiDbSemObjFullNameRenderer();

    protected MultiDbSemObjFullNameRenderer() {
    }
