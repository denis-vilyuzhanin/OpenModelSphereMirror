 ...
 */
public abstract class JackPositions {
    ...
    public abstract FilePositions getInitialValueStartPos();

    public abstract void setInitialValueStartPos(FilePositions pos);

    public abstract void setInitialValueEndPos(FilePositions pos);
