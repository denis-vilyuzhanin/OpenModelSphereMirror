...
public class ConnectAction extends AbstractApplicationAction implements ActiveConnectionListener {
    private static final String kConnect = LocaleMgr.action.getString("Connect");
    private static final String kDisconnect = LocaleMgr.action.getString("Disconnect");

    public ConnectAction() {
        super(kConnect);
        this.setMnemonic(LocaleMgr.action.getMnemonic("Connect"));
        setEnabled(true);
    ...
    public void activeConnectionChanged(ConnectionMessage cm) {
        putValue(NAME, cm == null ? kConnect : kDisconnect);
    }
}
