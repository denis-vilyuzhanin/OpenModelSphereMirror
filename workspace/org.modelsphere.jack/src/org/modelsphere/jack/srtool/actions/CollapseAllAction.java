...
public class CollapseAllAction extends AbstractApplicationAction implements CurrentFocusListener {

    public CollapseAllAction() {
        super(LocaleMgr.action.getString("CollapseAll"), LocaleMgr.action
                .getImageIcon("CollapseAll"));
        setEnabled(false);
    ...
    protected final void doActionPerformed() {
        ExplorerView explorerTree = ((ExplorerView) (ApplicationContext.getFocusManager()
                .getFocusObject()));
        TreePath[] treePaths = explorerTree.getSelectionPaths();
        explorerTree.collapseAllUnder(treePaths);
    }
