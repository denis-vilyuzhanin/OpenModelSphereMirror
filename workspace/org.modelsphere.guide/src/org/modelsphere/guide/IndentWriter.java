...
/**
 * An indent writer is a print writer that outputs indentation whitespace
 * after each newline. Calling <code>indent</code> and <code>outdent</code>
 * changes the indentation level. The default indentation width is 4
 * spaces.
 *
 */
 ...
 */
public void unindent() { if (--level < 0) level = 0; }
