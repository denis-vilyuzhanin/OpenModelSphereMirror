...
/**
 * For a procedure's parameter, tells whether it is a return parameter. <br>
 * Target System : <b>Informix</b><br>
 * Type : <b>User Function</b><br>
 * Returns : "true" or "false".<br>
 */
public final class INFParameterIsReturn extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("INFParameterIsReturn",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public INFParameterIsReturn() {
    } //Parameter-less constructor required by jack.io.Plugins

    public INFParameterIsReturn(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        DbINFParameter parameter = (DbINFParameter) object;
