...
/**
 * For an association end, returns its minimum connectivity according Datarun notation. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : One of the following :<br>
 * - '0' for an OPTIONAL or MANY multiplicity.<br>
 * - '1' for an EXACTLY_ONE or ONE_OR_MORE multiplicity.<br>
 */
public final class AssociationroleMinconn extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("AssociationroleMinconn",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public AssociationroleMinconn() {
    } //Parameter-less constructor required by jack.io.Plugins

    public AssociationroleMinconn(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        try {
            ...
            String label = mult.getDatarunMinimumMultiplicityLabel();
            output.write(label);
