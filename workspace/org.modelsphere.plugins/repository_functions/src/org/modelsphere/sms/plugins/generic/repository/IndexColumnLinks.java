...
public final class IndexColumnLinks extends Connector {

    //Navigate within all its components
    // private static final String COLUMN_LINKS = DbORIndex.fComponents.getJName();

    /*
     * In a .tpl file: idxCombins CONN IndexColumnLinks, CHILD = idxCombCol;
     * 
     * "pkTag" is the childRule
     */
    public IndexColumnLinks() {
    } //Parameter-less constructor required by jack.io.Plugins

    public IndexColumnLinks(String childRule) {
    ...
    //////////////////
    //OVERRIDES Plugin
    private static final PluginSignature g_signature = new IndexColumnLinksSignature();
    ...
    private static class IndexColumnLinksSignature extends PluginSignature {
        private static final String NAME = "IndexColumnLinks"; // NOT LOCALIZABLE
        ...
        public IndexColumnLinksSignature() {
