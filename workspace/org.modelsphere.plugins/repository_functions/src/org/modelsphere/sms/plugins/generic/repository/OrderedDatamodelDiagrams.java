...
/**
 * For a data model, lists all its diagrams by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedDatamodelDiagrams extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedDatamodelDiagrams", "$Revision: 4 $",
    ...
    public OrderedDatamodelDiagrams() {
...
} //end of OrderedDatamodelDiagrams
