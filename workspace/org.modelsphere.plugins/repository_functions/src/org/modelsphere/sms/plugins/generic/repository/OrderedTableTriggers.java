...
/**
 * For a table, lists all its triggers by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedTableTriggers extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedTableTriggers", "$Revision: 4 $",
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbORTable.fComponents, childRule, oneChildRule,
                DbORTrigger.metaClass);
        return conn;
    }
} //end of OrderedTableTriggers
