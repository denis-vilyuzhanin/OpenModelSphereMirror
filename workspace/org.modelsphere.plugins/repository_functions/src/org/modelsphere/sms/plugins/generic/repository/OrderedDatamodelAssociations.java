...
/**
 * For a data model, lists all its associations by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedDatamodelAssociations extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedDatamodelAssociations", "$Revision: 4 $",
    ...
    public OrderedDatamodelAssociations() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbORDataModel.fComponents, childRule, oneChildRule,
                DbORAssociation.metaClass);
        return conn;
    }
} //end of OrderedDatamodelAssociations
