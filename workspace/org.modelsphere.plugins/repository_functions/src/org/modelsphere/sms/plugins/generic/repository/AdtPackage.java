...
/**
 * For a classifier (class or interface), gets its package. <br>
 * Target System : <b>Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class AdtPackage extends Connector.UserConnector {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = new Connector(null, DbJVClass.fComposite, childRule,
    ...
    //////////////////
    //OVERRIDES Plugin
    private static final PluginSignature g_signature = new AdtPackageSignature();
    ...
    private static class AdtPackageSignature extends PluginSignature {
        private static final String NAME = "AdtPackage"; // NOT LOCALIZABLE
