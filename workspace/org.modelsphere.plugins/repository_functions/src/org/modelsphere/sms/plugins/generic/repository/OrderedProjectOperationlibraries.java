...
/**
 * For a project, lists all its operation libraries by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedProjectOperationlibraries extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedProjectOperationlibraries", "$Revision: 4 $",
    ...
    public OrderedProjectOperationlibraries() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbSMSProject.fComponents, childRule, oneChildRule,
                DbOROperationLibrary.metaClass);
        return conn;
    }
} //end of OrderedProjectOperationlibraries
