...
/**
 * For any object, tells whether it is a built-in type. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : "true" or "false".<br>
 */
public final class ObjectIsbuiltintype extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("ObjectIsbuiltintype",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public ObjectIsbuiltintype() {
    } //Parameter-less constructor required by jack.io.Plugins

    public ObjectIsbuiltintype(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        if (object instanceof DbORBuiltInType)
