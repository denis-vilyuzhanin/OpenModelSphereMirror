...
/**
 * For a table, lists all its foreign keys by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedTableForeignkeys extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedTableForeignkeys", "$Revision: 4 $",
    ...
    public OrderedTableForeignkeys() {
