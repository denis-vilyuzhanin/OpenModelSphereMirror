...
/**
 * For any object, tells whether it is primitive type. <br>
 * Target System : <b>Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : "true" or "false".<br>
 */
public final class ObjectIsprimitivetype extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("ObjectIsprimitivetype",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212);// NOT LOCALIZABLE

    public ObjectIsprimitivetype() {
    } //Parameter-less constructor required by jack.io.Plugins

    public ObjectIsprimitivetype(String ruleName, String subRule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        if (object instanceof DbOOPrimitiveType)
