...
/**
 * For a operation library, lists all its procedures by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedOperationlibraryProcedures extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedOperationlibraryProcedures",
    ...
    public OrderedOperationlibraryProcedures() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbOROperationLibrary.fComponents, childRule,
                oneChildRule, DbORProcedure.metaClass);
        return conn;
    }
} //end of OrderedOperationlibraryProcedures
