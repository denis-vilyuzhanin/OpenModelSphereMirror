...
/**
 * For a table, lists all its constraints by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedTableConstraints extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedTableConstraints", "$Revision: 4 $",
    ...
    public OrderedTableConstraints() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbORTable.fComponents, childRule, oneChildRule,
                DbORConstraint.metaClass);
        return conn;
    }
} //end of OrderedTableConstraints
