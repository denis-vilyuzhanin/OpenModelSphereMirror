...
public class ReverseJavaSourcecodeWizard extends Wizard<ReverseJavaSourcecodeParameters> {

    public ReverseJavaSourcecodeWizard(ReverseJavaSourcecodeParameters params) {
        super(params);
        new ReverseJavaSourcecodeWizardPage1(this);
        new ReverseJavaSourcecodeWizardPage2(this);
    }
}
