 ...
 **/
public final class DbGEForeign extends DbORForeign {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGEForeign"),
            DbGEForeign.class, new MetaField[] {}, MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGEForeign.
     * 
     * @param assocend
     *            org.modelsphere.sms.or.db.DbORAssociationEnd
     **/
    public DbGEForeign(DbORAssociationEnd assocEnd) throws DbException {
        super(assocEnd);
