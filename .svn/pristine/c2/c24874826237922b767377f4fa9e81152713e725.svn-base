 ...
 **/
public final class DbJVInheritance extends DbOOInheritance {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbJVInheritance"), DbJVInheritance.class, new MetaField[] {},
            MetaClass.NO_UDF);
    ...
    public static void initMeta() {
        try {
            metaClass.setSuperMetaClass(DbOOInheritance.metaClass);
     ...
     *            org.modelsphere.sms.oo.java.db.DbJVClass
     **/
    public DbJVInheritance(DbJVClass subClass, DbJVClass superClass) throws DbException {
