 ...
 **/
public final class DbGECheck extends DbORCheck {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbGECheck"),
            DbGECheck.class, new MetaField[] {}, MetaClass.MATCHABLE);
    ...
    /**
     * Creates an instance of DbGECheck.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGECheck(DbObject composite) throws DbException {
        super(composite);
