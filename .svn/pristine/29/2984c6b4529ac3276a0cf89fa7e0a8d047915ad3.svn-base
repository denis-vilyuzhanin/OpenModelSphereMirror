 ...
 **/
public final class DbJVInitBlock extends DbOOInitBlock {

    //Meta

    public static final MetaClass metaClass = new MetaClass(
            LocaleMgr.db.getString("DbJVInitBlock"), DbJVInitBlock.class, new MetaField[] {}, 0);
    ...
    public static void initMeta() {
        try {
            metaClass.setSuperMetaClass(DbOOInitBlock.metaClass);
     ...
     **/
    public DbJVInitBlock(DbObject composite) throws DbException {
        super(composite);
        setDefaultInitialValues();
    }

    private void setDefaultInitialValues() throws DbException {
        setName(LocaleMgr.misc.getString("initBlock"));
    }
