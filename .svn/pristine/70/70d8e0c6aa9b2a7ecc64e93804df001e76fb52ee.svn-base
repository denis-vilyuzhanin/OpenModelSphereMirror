 ...
 **/
public final class DbIBMDataModel extends DbORDataModel {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbIBMDataModel"), DbIBMDataModel.class, new MetaField[] {},
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbIBMTable.metaClass,
                    DbIBMView.metaClass, DbIBMSequence.metaClass });
     ...
     **/
    public DbIBMDataModel(DbObject composite, DbSMSTargetSystem targetSystem) throws DbException {
     ...
     *            int
     **/
    public DbIBMDataModel(DbObject composite, DbSMSTargetSystem targetSystem, int logicalMode)
            throws DbException {
