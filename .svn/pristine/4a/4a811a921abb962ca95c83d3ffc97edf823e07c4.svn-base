...
/**
 * For a operation library, lists all its packages by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedOperationlibraryPackages extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedOperationlibraryPackages", "$Revision: 4 $",
    ...
    public OrderedOperationlibraryPackages() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbOROperationLibrary.fComponents, childRule,
                oneChildRule, DbORPackage.metaClass);
        return conn;
    }
} //end of OrderedOperationlibraryPackages
