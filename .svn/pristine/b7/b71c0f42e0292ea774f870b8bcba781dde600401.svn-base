 ...
 **/
public final class DbORACheck extends DbORCheck {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbORACheck"),
            DbORACheck.class, new MetaField[] { fChecking, fDeferrable, fEnabled, fValidated,
    ...
    public static void initMeta() {
        try {
            ...
            fChecking.setJField(DbORACheck.class.getDeclaredField("m_checking"));
            fDeferrable.setJField(DbORACheck.class.getDeclaredField("m_deferrable"));
            fEnabled.setJField(DbORACheck.class.getDeclaredField("m_enabled"));
            fValidated.setJField(DbORACheck.class.getDeclaredField("m_validated"));
            fExceptionTable.setJField(DbORACheck.class.getDeclaredField("m_exceptionTable"));
            fExceptionTable.setRendererPluginName("DbORTable");

            fExceptionTable.setOppositeRel(DbORATable.fCheckConstraints);
 ...
 **/
    ...
    /**
     * Gets the "deferrable" property's Boolean value of a DbORACheck's instance.
     * 
