...
public class IBMProcedureSql extends IntDomain {

    static final long serialVersionUID = 0;
    public static final int READS_SQL_DATA = 1;
    public static final int NO_SQL = 2;
    public static final int CONTAINS_SQL = 3;

    protected IBMProcedureSql(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMProcedureSql(value);
    }

    public static final String[] stringPossibleValues = new String[] { "",
            LocaleMgr.misc.getString("ReadsSqlData"), LocaleMgr.misc.getString("NoSql"),
            LocaleMgr.misc.getString("ContainsSql") };

    public static final IBMProcedureSql[] objectPossibleValues = new IBMProcedureSql[] {
            new IBMProcedureSql(0), new IBMProcedureSql(READS_SQL_DATA),
            new IBMProcedureSql(NO_SQL), new IBMProcedureSql(CONTAINS_SQL) };
