...
public class ORAEnableDisable extends IntDomain {
    ...
    public static final ORAEnableDisable[] objectPossibleValues = new ORAEnableDisable[] {
            new ORAEnableDisable(ENABLE), new ORAEnableDisable(DISABLE) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("enable"), LocaleMgr.misc.getString("disable") };

    public static ORAEnableDisable getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAEnableDisable(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAEnableDisable() {
    }

    public final DbtAbstract duplicate() {
        return new ORAEnableDisable(value);
    }
