...
/**
 * For a table's column, tells whether it is connected to a Sbspace. <br>
 * Target System : <b>Informix</b><br>
 * Type : <b>User Function</b><br>
 * Returns : "true" or "false".<br>
 */
public final class INFColumnIslinkedwithsbpaces extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature(
            "INFColumnIslinkedwithsbpaces", "$Revision: 4 $",
            ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $", 212); // NOT LOCALIZABLE

    public INFColumnIslinkedwithsbpaces() {
    } //Parameter-less constructor required by jack.io.Plugins

    public INFColumnIslinkedwithsbpaces(String ruleName, String subrule, Modifier[] modifiers)
