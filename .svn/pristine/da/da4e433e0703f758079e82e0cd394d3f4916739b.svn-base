...
public class UserType extends IntDomain {
    ...
    public static final UserType[] objectPossibleValues = new UserType[] { new UserType(USER),
            new UserType(ADMIN), new UserType(GUEST) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("User"), LocaleMgr.misc.getString("Admin"),
            LocaleMgr.misc.getString("Guest") };

    public static UserType getInstance(int value) {
