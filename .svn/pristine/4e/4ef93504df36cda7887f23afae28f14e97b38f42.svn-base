 ...
 */
public class MultiSrFontRenderer extends MultiDefaultRenderer {
    public static final MultiSrFontRenderer singleton = new MultiSrFontRenderer();
