...
public class IBMSizeUnit extends IntDomain {
    ...
    public static final IBMSizeUnit[] objectPossibleValues = new IBMSizeUnit[] {
            new IBMSizeUnit(KB), new IBMSizeUnit(MB), new IBMSizeUnit(GB) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("kb"), LocaleMgr.misc.getString("mb"),
            LocaleMgr.misc.getString("gb") };

    public static IBMSizeUnit getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected IBMSizeUnit(int value) {
        super(value);
    }
