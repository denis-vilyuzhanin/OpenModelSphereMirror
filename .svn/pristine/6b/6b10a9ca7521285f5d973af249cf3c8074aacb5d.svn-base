 ...
 */
public class MultiExternalDocumentEditor implements ActionListener, TableCellEditor {
    public static final MultiExternalDocumentEditor singleton = new MultiExternalDocumentEditor();
    ...
    public final void actionPerformed(ActionEvent ev) {
        if (m_command == null) {
            ...
            if (obj instanceof String) {
                m_command = (String) obj;
            }
        }

        DefaultMainFrame mf = ApplicationContext.getDefaultMainFrame();
        m_command = ExternalDocumentEditor.doActionPerformed(mf, row, m_command, actionBtn);
    } // end actionPerformed()
...
} // end MultiExternalDocumentEditor
