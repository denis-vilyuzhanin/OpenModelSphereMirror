...
/**
 * For a domain, gets its interval qualifier. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Returns : String<br>
 */
public class IntervalQualifier extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("IntervalQualifier",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    private static final String typeName = new String("INTERVAL"); // NOT LOCALIZABLE

    public IntervalQualifier() {
    } //Parameter-less constructor required by jack.io.Plugins

    public IntervalQualifier(String ruleName, String subrule, Modifier[] modifiers)
