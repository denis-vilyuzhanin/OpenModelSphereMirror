 ...
 * 
 * <b>Composites : </b><A
 * HREF="../../../../../../org/modelsphere/sms/or/ibm/db/DbIBMProcedure.html">DbIBMProcedure</A>.<br>
 * <b>Components : </b><A
 * HREF="../../../../../../org/modelsphere/sms/db/DbSMSObjectImport.html">DbSMSObjectImport</A>.<br>
 **/
public final class DbIBMParameter extends DbORParameter {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbIBMParameter"), DbIBMParameter.class, new MetaField[] { fLocator }, 0);
    ...
    public static void initMeta() {
        try {
            ...
            fLocator.setJField(DbIBMParameter.class.getDeclaredField("m_locator"));
     ...
     **/
    public DbIBMParameter(DbObject composite) throws DbException {
        super(composite);
 ...
 **/
    ...
    /**
     * Gets the "locator" property's Boolean value of a DbIBMParameter's instance.
     * 
