...
public class ORATriggerTime extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int BEFORE = 1;
    public static final int AFTER = 2;
    public static final int INSTEADOF = 3;

    public static final ORATriggerTime[] objectPossibleValues = new ORATriggerTime[] {
            new ORATriggerTime(BEFORE), new ORATriggerTime(AFTER), new ORATriggerTime(INSTEADOF) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("before"), LocaleMgr.misc.getString("after"),
            LocaleMgr.misc.getString("insteadof") };

    public static ORATriggerTime getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORATriggerTime(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORATriggerTime() {
    }

    public final DbtAbstract duplicate() {
        return new ORATriggerTime(value);
    }
