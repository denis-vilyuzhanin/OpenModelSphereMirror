 ...
 **/
public final class DbORTableGo extends DbSMSClassifierGo {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbORTableGo"),
            DbORTableGo.class, new MetaField[] {}, MetaClass.NO_UDF);
