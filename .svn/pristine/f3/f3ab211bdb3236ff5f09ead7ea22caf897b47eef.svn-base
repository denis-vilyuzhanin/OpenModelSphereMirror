...
public class IBMBufferPoolDeferred extends IntDomain {
    ...
    protected IBMBufferPoolDeferred(int value) {
        super(value);
    }
    ...
    public final DbtAbstract duplicate() {
        return new IBMBufferPoolDeferred(value);
    }

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString(""), LocaleMgr.misc.getString("deferred"),
            LocaleMgr.misc.getString("immediate"), };

    public static final IBMBufferPoolDeferred[] objectPossibleValues = new IBMBufferPoolDeferred[] {
            new IBMBufferPoolDeferred(UNSPECIFIED), new IBMBufferPoolDeferred(DEFERRED),
            new IBMBufferPoolDeferred(IMMEDIATE) };
