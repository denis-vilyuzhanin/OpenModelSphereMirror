...
public class ORAViewConstraint extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int READONLY = 1;
    public static final int CHECKOPTION = 2;

    public static final ORAViewConstraint[] objectPossibleValues = new ORAViewConstraint[] {
            new ORAViewConstraint(READONLY), new ORAViewConstraint(CHECKOPTION) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("readonly"), LocaleMgr.misc.getString("checkoption") };

    public static ORAViewConstraint getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAViewConstraint(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAViewConstraint() {
    }

    public final DbtAbstract duplicate() {
        return new ORAViewConstraint(value);
    }
