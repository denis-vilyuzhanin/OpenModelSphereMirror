...
public interface ToolComponent {
    ...
    public static final int STATE_SELECTED = 0x01;
    public static final int STATE_MASTER = 0x02;

    // update the state of this component to represent the newState
    ...
    // get or set the auxiliary selection index -  if not supported, return -1;
