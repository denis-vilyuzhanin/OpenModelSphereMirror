...
/**
 * For an association end, returns the name of the table on which the association end is attached. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 */
public final class AssociationroleOrigintable extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature(
            "AssociationroleOrigintable", "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR,
            "$Date: 2009/04/14 14:00p $", 212); // NOT LOCALIZABLE

    public AssociationroleOrigintable() {
    } //Parameter-less constructor required by jack.io.Plugins

    public AssociationroleOrigintable(String ruleName, String subRule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        try {
            ...
            output.write(associationEnd.getClassifier().getName());
            expanded = true;
