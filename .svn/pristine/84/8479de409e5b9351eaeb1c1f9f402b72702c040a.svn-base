 ...
 **/
public final class DbGEParameter extends DbORParameter {

    //Meta

    public static final MetaClass metaClass = new MetaClass(
            LocaleMgr.db.getString("DbGEParameter"), DbGEParameter.class, new MetaField[] {}, 0);
     ...
     **/
    public DbGEParameter() {
    }

    /**
     * Creates an instance of DbGEParameter.
     * 
     * @param composite
     *            the object which will contain the newly-created instance
     **/
    public DbGEParameter(DbObject composite) throws DbException {
        super(composite);
