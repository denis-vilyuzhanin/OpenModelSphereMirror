...
/**
 * Returns the output directory of DDL files. <br>
 ...
 */
public final class DDLOutputDirectory extends UserDefinedField {

    private static final PluginSignature signature = new PluginSignature("DDLOutputDirectory",
    ...
    public DDLOutputDirectory() {
    } //Parameter-less constructor required by jack.io.Plugins

    public DDLOutputDirectory(String ruleName, String subRule, Modifier[] modifiers)
