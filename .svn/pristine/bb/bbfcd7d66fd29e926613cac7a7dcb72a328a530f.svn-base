...
public class ORAConstraintChecking extends IntDomain {
    ...
    public static final ORAConstraintChecking[] objectPossibleValues = new ORAConstraintChecking[] {
            new ORAConstraintChecking(IMMEDIATE), new ORAConstraintChecking(DEFERRED) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("immediate"), LocaleMgr.misc.getString("deferred") };

    public static ORAConstraintChecking getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAConstraintChecking(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAConstraintChecking() {
    }

    public final DbtAbstract duplicate() {
        return new ORAConstraintChecking(value);
    }
