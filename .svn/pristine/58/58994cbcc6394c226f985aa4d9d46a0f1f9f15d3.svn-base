...
public class INFLockMode extends IntDomain {
    ...
    public static final INFLockMode[] objectPossibleValues = new INFLockMode[] {
            new INFLockMode(PAGE), new INFLockMode(ROW), new INFLockMode(TABLE) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("page"), LocaleMgr.misc.getString("row"),
            LocaleMgr.misc.getString("table") };

    public static INFLockMode getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected INFLockMode(int value) {
        super(value);
    }
