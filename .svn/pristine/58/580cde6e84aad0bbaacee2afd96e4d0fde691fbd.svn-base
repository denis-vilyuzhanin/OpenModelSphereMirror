...
/**
 * For a package, lists all its procedures by the alphabetical order of their names. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>Connector</b><br>
 */
public final class OrderedPackageProcedures extends OrderedConnector {

    private PluginSignature m_signature = null;

    public PluginSignature getSignature() {
        if (m_signature == null) {
            m_signature = new PluginSignature("OrderedPackageProcedures", "$Revision: 4 $",
    ...
    public OrderedPackageProcedures() {
    ...
    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = super.createInstance(DbORPackage.fComponents, childRule, oneChildRule,
                DbORProcedure.metaClass);
        return conn;
    }
} //end of OrderedPackageProcedures
