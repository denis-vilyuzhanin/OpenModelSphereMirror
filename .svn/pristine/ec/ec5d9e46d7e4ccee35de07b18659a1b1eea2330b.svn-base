...
/**
 * For a fragment, tells whether it is a remainder. <br>
 * Target System : <b>Informix</b><br>
 * Type : <b>User Function</b><br>
 * Returns : "true" or "false".<br>
 */
public final class INFFragmentIsRemainder extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("INFFragmentIsRemainder",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public INFFragmentIsRemainder() {
    } //Parameter-less constructor required by jack.io.Plugins

    public INFFragmentIsRemainder(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        DbINFFragment fragment = (DbINFFragment) object;

        try {
            if (fragment.isRemainder())
