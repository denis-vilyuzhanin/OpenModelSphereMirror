 ...
 * 
 */
public final class DuplicatedRulenamesException extends ParseException {

    private static final String MESSAGE_PATTERN = LocaleMgr.message
            .getString("MoreThanOneRuleOneTheSameName");
    ...
    public DuplicatedRulenamesException(String msg) {
        super(msg);
    }
}
