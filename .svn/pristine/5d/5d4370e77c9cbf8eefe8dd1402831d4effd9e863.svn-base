...
/**
 * For any object, tells whether it is a view. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : "true" or "false".<br>
 */
public final class ObjectIsview extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("ObjectIsview",
    ...
    public ObjectIsview(String ruleName, String subrule, Modifier[] modifiers) throws RuleException {
