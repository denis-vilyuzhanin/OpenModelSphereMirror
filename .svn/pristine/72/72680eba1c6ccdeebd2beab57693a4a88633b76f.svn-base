...
/**
 * Thrown by INSTANCEOF operation
 * 
 * This exception occurs when we are processing a INSTANCEOF operation on a concept that does not
 * exist.
 * 
 */
public final class ConceptNameNotFoundException extends ParseException {

    private static final String MESSAGE_PATTERN = LocaleMgr.message
            .getString("ConceptNotRecognized");
    ...
    public ConceptNameNotFoundException(String msg) {
        super(msg);
    }
}
