 ...
 * HREF="../../../../../../org/modelsphere/sms/or/oracle/db/DbORASequence.html">DbORASequence</A>,
 * <A HREF="../../../../../../org/modelsphere/sms/or/db/DbORAssociation.html">DbORAssociation</A>,
 * <A HREF="../../../../../../org/modelsphere/sms/or/db/DbORDataModel.html">DbORDataModel</A>, <A
 ...
 **/
public final class DbORADataModel extends DbORDataModel {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbORADataModel"), DbORADataModel.class, new MetaField[] {},
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbORAView.metaClass,
                    DbORATable.metaClass, DbORASequence.metaClass });
     ...
     **/
    public DbORADataModel(DbObject composite, DbSMSTargetSystem targetSystem) throws DbException {
     ...
     *            int
     **/
    public DbORADataModel(DbObject composite, DbSMSTargetSystem targetSystem, int logicalMode)
            throws DbException {
