...
import org.modelsphere.sms.oo.java.JavaOverridingUpdate;
...
final class UpdateInheritanceAction extends AbstractApplicationAction implements
        SelectionActionListener {

    UpdateInheritanceAction() {
        super(LocaleMgr.action.getString("updateInheritance"));
        this.setMnemonic(LocaleMgr.action.getMnemonic("updateInheritance"));
    }
    ...
    protected final void doActionPerformed() {
        ...
        try {
            DbMultiTrans.beginTrans(Db.WRITE_TRANS, semObjs, LocaleMgr.action
                    .getString("updateInheritance"));
            new JavaOverridingUpdate(semObjs);
