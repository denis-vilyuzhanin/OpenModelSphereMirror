...
public class ORASizeUnit extends IntDomain {
    ...
    public static final ORASizeUnit[] objectPossibleValues = new ORASizeUnit[] {
            new ORASizeUnit(KB), new ORASizeUnit(MB) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("kb"), LocaleMgr.misc.getString("mb") };

    public static ORASizeUnit getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORASizeUnit(int value) {
        super(value);
    }
