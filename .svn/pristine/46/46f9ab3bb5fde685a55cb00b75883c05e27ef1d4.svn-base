 ...
 **/
public final class DbBEStoreQualifier extends DbBEQualifierLink {
    ...
    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbBEStoreQualifier"), DbBEStoreQualifier.class,
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setIcon("dbbestorequalifier.gif");

            fQualifier.setJField(DbBEStoreQualifier.class.getDeclaredField("m_qualifier"));
            ...
            fQualifier.setOppositeRel(DbBEQualifier.fQualifiedStores);
     ...
     **/
    public DbBEStoreQualifier(DbObject composite, DbSMSSemanticalObject semObj) throws DbException {
        super(composite);
