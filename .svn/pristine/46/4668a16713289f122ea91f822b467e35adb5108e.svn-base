...
import org.modelsphere.sms.or.graphic.tool.ORCommonItemTool;

public final class ORCommonItemModelToolkit extends SMSToolkit {
    ...
    protected MetaClass[] getSupportedPackage() {
        return new MetaClass[] { DbORCommonItemModel.metaClass };
    }

    public DbObject createDbObject(MetaClass abstractMetaClass, DbObject composite,
            Object[] parameters) throws DbException {
        if (composite != null) {
            if (abstractMetaClass.equals(DbORCommonItem.metaClass))
                return composite.createComponent(DbORCommonItem.metaClass);
        }
        return null;
    }
    ...
    public Tool[] createTools() {
        return new Tool[] {
                new ORCommonItemTool(ORCommonItemTool.kCommonItemCreationTool,
                        ORCommonItemTool.kImageCommonItemCreationTool),
                new SMSNoticeTool(),
