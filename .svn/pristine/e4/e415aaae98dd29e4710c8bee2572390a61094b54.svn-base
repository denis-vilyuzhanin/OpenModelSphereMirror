 ...
 * 
 */
public abstract class MetaRelation extends MetaRelationship {

    MetaRelationship oppositeRel; // MetaChoice needs access to this field

    public MetaRelation(String name, int minCard, int maxCard) {
        super(name, minCard, maxCard);
    }

    public final void setOppositeRel(MetaRelation oppositeRel) {
        this.oppositeRel = oppositeRel;
        oppositeRel.oppositeRel = this;
    }
