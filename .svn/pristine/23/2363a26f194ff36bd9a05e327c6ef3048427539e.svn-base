...
public class INFTriggerTime extends IntDomain {
    ...
    public static final INFTriggerTime[] objectPossibleValues = new INFTriggerTime[] {
            new INFTriggerTime(BEFORE), new INFTriggerTime(AFTER) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("before"), LocaleMgr.misc.getString("after") };

    public static INFTriggerTime getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected INFTriggerTime(int value) {
        super(value);
    }

    //Parameterless constructor
    public INFTriggerTime() {
    }

    public final DbtAbstract duplicate() {
        return new INFTriggerTime(value);
    }
