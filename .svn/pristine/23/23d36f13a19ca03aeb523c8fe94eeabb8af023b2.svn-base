...
public final class SetProjectDefaultORNotationAction extends AbstractDomainAction implements
        SelectionActionListener {

    private static final String kDefaultNotation = LocaleMgr.action
            .getString("ProjectDefaultORNotation");
    private static final String kSetDefaultNotation = LocaleMgr.action
            .getString("setdefaultORnotation");

    private ArrayList notations = new ArrayList(0); // null object means

    // separator

    public SetProjectDefaultORNotationAction() {
        super(kDefaultNotation);
        this.setMnemonic(LocaleMgr.action.getMnemonic("ProjectDefaultORNotation"));
        setEnabled(false);
    ...
    protected final void doActionPerformed() {
        ...
        if (selidx != -1) {
            ...
            try {
                ...
                if (notation != null)
                    project.setOrDefaultNotation(notation);
    ...
    public final void updateSelectionAction() throws DbException {
        ...
        DbORNotation selnotation = project.getOrDefaultNotation();
