...
/**
 * Returns the output directory of java files. <br>
 ...
 */
public final class JavaOutputDirectory extends UserDefinedField {

    private static final PluginSignature signature = new PluginSignature("JavaOutputDirectory",
    ...
    public JavaOutputDirectory() {
    } //Parameter-less constructor required by jack.io.Plugins

    public JavaOutputDirectory(String ruleName, String subRule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String defDir = DirectoryOptionGroup.getJavaGenerationDirectory();
        output.write(defDir);
        expanded = true;
