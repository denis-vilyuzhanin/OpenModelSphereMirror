...
/**
 * For any object, tells whether it is a Java class. <br>
 * Target System : <b>Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : "true" or "false".<br>
 */
public final class ObjectIsclass extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("ObjectIsclass",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public ObjectIsclass() {
    } //Parameter-less constructor required by jack.io.Plugins

    public ObjectIsclass(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        if (object instanceof DbOOClass)
     ...
     * RuleException { boolean expanded = wrappedExpand(output, object); super.processModifier();
     * 
     * return expanded; }
     */
} //end of ObjectID
