 ...
 * <A HREF="../../../../../../org/modelsphere/sms/or/oracle/db/DbORAPackage.html">DbORAPackage</A>,
 * <A HREF="../../../../../../org/modelsphere/sms/db/DbSMSNotice.html">DbSMSNotice</A>, <A
 * HREF="../../../../../../org/modelsphere/sms/db/DbSMSObjectImport.html">DbSMSObjectImport</A>.<br>
 **/
public final class DbORAProgramUnitLibrary extends DbOROperationLibrary {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbORAProgramUnitLibrary"), DbORAProgramUnitLibrary.class,
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setComponentMetaClasses(new MetaClass[] { DbORAProcedure.metaClass,
                    DbORAPackage.metaClass });
            metaClass.setIcon("dboraprogramunitlibrary.gif");
     ...
     **/
    public DbORAProgramUnitLibrary() {
    }
     ...
     **/
    public DbORAProgramUnitLibrary(DbObject composite, DbSMSTargetSystem targetSystem)
            throws DbException {
    ...
    private void setDefaultInitialValues() throws DbException {
        setName(LocaleMgr.misc.getString("programUnitLib"));
    }
