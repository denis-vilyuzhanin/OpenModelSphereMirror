...
public class ORACompress extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int COMPRESS = 1;
    public static final int NOCOMPRESS = 2;

    public static final ORACompress[] objectPossibleValues = new ORACompress[] {
            new ORACompress(COMPRESS), new ORACompress(NOCOMPRESS) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("compress"), LocaleMgr.misc.getString("nocompress") };

    public static ORACompress getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORACompress(int value) {
        super(value);
    }
