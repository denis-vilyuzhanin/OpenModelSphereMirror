...
public class ORALanguage extends IntDomain {
    ...
    public static final ORALanguage[] objectPossibleValues = new ORALanguage[] {
            new ORALanguage(PLSQL), new ORALanguage(JAVA) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("plsql"), LocaleMgr.misc.getString("java") };

    public static ORALanguage getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORALanguage(int value) {
        super(value);
    }
