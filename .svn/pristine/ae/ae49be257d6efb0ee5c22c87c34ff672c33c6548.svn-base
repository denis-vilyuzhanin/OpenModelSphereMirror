...
public class FlowComponent extends OptionComponent {
    public FlowComponent(NotationComponent NotationComponent, MetaField[] metaFields) {
        super(NotationComponent, metaFields);
        optionPanel = new FlowComponentPanel(this);
    }
    ...
    private void initFields() throws DbException {
        ((FlowComponentPanel) optionPanel).initFields((DbBENotation) notation, values);
    }
