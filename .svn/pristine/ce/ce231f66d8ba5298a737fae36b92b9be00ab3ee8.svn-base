...
public class ORAMonitoring extends IntDomain {

    static final long serialVersionUID = 0;

    public static final int MONITORING = 1;
    public static final int NOMONITORING = 2;

    public static final ORAMonitoring[] objectPossibleValues = new ORAMonitoring[] {
            new ORAMonitoring(MONITORING), new ORAMonitoring(NOMONITORING) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("monitoring"), LocaleMgr.misc.getString("nomonitoring") };

    public static ORAMonitoring getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAMonitoring(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAMonitoring() {
    }

    public final DbtAbstract duplicate() {
        return new ORAMonitoring(value);
    }
