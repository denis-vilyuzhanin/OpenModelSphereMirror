...
public class NotationSymbolComponent extends OptionComponent {
    private DbORNotation notation;

    public NotationSymbolComponent(NotationComponent NotationComponent, MetaField[] metaFields) {
        super(NotationComponent, metaFields);
        optionPanel = new NotationSymbolComponentPanel(this);
        // initFields();
    }
    ...
    private void initFields() {
        ((NotationSymbolComponentPanel) optionPanel).initFields(values);
    }
