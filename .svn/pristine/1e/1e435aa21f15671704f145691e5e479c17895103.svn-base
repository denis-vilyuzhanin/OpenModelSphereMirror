 ...
 * HREF="../../../../../org/modelsphere/sms/oo/java/db/DbJVConstructor.html">DbJVConstructor</A>.<br>
 * 
 * <b>Composites : </b><A
 ...
 **/
public abstract class DbOOConstructor extends DbOOAbstractMethod {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db
            .getString("DbOOConstructor"), DbOOConstructor.class, new MetaField[] {},
    ...
    public static void initMeta() {
        try {
            ...
            metaClass.setIcon("dbooconstructor.gif");
     ...
     **/
    public DbOOConstructor(DbObject composite) throws DbException {
        super(composite);
        setDefaultInitialValues();
    }

    private void setDefaultInitialValues() throws DbException {
        setName(null); // the parameter is ignored anyway
    }
    ...
    public final void setName(String name) throws DbException {
        super.setName(((DbOOClass) getComposite()).getName());
    }
