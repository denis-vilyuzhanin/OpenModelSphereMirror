 ...
 * instructions on using this class, see http://java.sun.com/products/jfc/swingdoc/threads.html
 */
...
public abstract class SwingWorker {
    ...
    /**
     * Start a thread that will call the <code>construct</code> method and then exit. Worker is now
     * able to both invoke later or invoke and wait.
     */
    public SwingWorker(final boolean wait) {
                ...
                if (wait == false) {
                    ...
                    try {
                        try {
                            ...
                            org.modelsphere.jack.debug.Debug.trace("InterruptedException"); // NOT
                            // LOCALIZABLE,
                            // property
                            // key
