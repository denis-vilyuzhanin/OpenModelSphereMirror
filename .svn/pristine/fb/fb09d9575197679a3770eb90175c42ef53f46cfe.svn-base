...
public class INFProcedureLanguage extends IntDomain {
    ...
    public static final INFProcedureLanguage[] objectPossibleValues = new INFProcedureLanguage[] {
            new INFProcedureLanguage(SPL), new INFProcedureLanguage(JAVA),
            new INFProcedureLanguage(C) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("spl"), LocaleMgr.misc.getString("java"),
            LocaleMgr.misc.getString("c") };

    public static INFProcedureLanguage getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected INFProcedureLanguage(int value) {
        super(value);
    }

    //Parameterless constructor
    public INFProcedureLanguage() {
    }

    public final DbtAbstract duplicate() {
        return new INFProcedureLanguage(value);
    }
