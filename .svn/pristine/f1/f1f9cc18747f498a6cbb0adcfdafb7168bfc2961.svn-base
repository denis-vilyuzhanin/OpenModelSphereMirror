...
/**
 * For an association end, returns its multiplicity according Datarun notation. <br>
 * Target System : <b>All Except Java</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : One of the following :<br>
 * - '0,N' for a MANY multiplicity.<br>
 * - '1,N' for a ONE_OR_MORE multiplicity.<br>
 * - '1,1' for a EXACTLY_ONE multiplicity<br>
 * . - '0,1' for a OPTIONAL multiplicity.<br>
 */
public final class AssociationroleConnectivity extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature(
            "AssociationroleConnectivity", "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR,
            "$Date: 2009/04/14 14:00p $", 212); // NOT LOCALIZABLE

    public AssociationroleConnectivity() {
    } //Parameter-less constructor required by jack.io.Plugins

    public AssociationroleConnectivity(String ruleName, String subRule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        try {
            ...
            String label = mult.getDatarunMultiplicityLabel();
            output.write(label);
            expanded = true;
