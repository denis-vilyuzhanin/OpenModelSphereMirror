...
/**
 * For a diagram, tells whether it is empty. <br>
 * Target System : <b>All</b><br>
 * Type : <b>User Function</b><br>
 * Parameters : none.<br>
 * Returns : "true" or "false".<br>
 */
public final class DiagramIsempty extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature("DiagramIsempty",
            "$Revision: 4 $", ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $",
            212); // NOT LOCALIZABLE

    public DiagramIsempty() {
    } //Parameter-less constructor required by jack.io.Plugins

    public DiagramIsempty(String ruleName, String subrule, Modifier[] modifiers)
    ...
    public boolean expand(Writer output, Serializable object, Rule.RuleOptions options)
        ...
        String value;
        DbSMSDiagram diagram = (DbSMSDiagram) object;
