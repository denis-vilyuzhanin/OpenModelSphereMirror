 ...
 * HREF="../../../../../org/modelsphere/sms/oo/java/db/DbJVPackage.html">DbJVPackage</A>.<br>
 * 
 ...
 **/
public abstract class DbOOPackage extends DbOOAbsPackage {

    //Meta

    public static final MetaClass metaClass = new MetaClass(LocaleMgr.db.getString("DbOOPackage"),
            DbOOPackage.class, new MetaField[] {}, 0);
     ...
     **/
    public DbOOPackage(DbObject composite) throws DbException {
        super(composite);
