...
public class ORACategory extends IntDomain {
    ...
    public static final ORACategory[] objectPossibleValues = new ORACategory[] {
            new ORACategory(GLOBAL), new ORACategory(LOCAL) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("global"), LocaleMgr.misc.getString("local") };

    public static ORACategory getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORACategory(int value) {
        super(value);
    }
