...
public final class ProjectPropertiesAction extends AbstractApplicationAction implements
        SelectionActionListener {
    public ProjectPropertiesAction() {
        super(LocaleMgr.action.getString("projectProperties"));
        this.setMnemonic(LocaleMgr.action.getMnemonic("projectProperties"));
        setEnabled(false);
    }
    ...
    protected final void doActionPerformed() {
        ...
        try {
            ...
            mainFrame.addPropertyInternalFrame(project);
