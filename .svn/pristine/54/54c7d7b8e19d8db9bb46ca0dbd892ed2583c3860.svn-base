...
public final class NotationAction extends AbstractApplicationAction implements
        CurrentProjectListener {

    public NotationAction() {
        super(LocaleMgr.action.getString("notations"));
        this.setMnemonic(LocaleMgr.action.getMnemonic("notations"));
        setEnabled(false);
