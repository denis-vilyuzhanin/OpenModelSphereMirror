...
public final class SMSZoneOrientation extends IntDomain {
    ...
    public static final SMSZoneOrientation[] objectPossibleValues = new SMSZoneOrientation[] {
            new SMSZoneOrientation(HORIZONTAL), new SMSZoneOrientation(PERPENDICULAR) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("horizontal"), LocaleMgr.misc.getString("perpendicular") };

    public static SMSZoneOrientation getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    // Parameterless constructor
    public SMSZoneOrientation() {
    }

    protected SMSZoneOrientation(int value) {
        super(value);
    }

    public final DbtAbstract duplicate() {
        return new SMSZoneOrientation(value);
    }
