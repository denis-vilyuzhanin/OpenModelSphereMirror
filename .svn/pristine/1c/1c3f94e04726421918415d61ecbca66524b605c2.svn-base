...
public final class BEDiagramLayout extends DiagramLayout {

    public BEDiagramLayout(DbObject diagGO, GraphicComponent[] selComps) throws DbException {
        super(diagGO, selComps);
    }

    protected final boolean isNode(DbObject go) {
        return (go instanceof DbBEUseCaseGo || go instanceof DbBEActorGo || go instanceof DbBEStoreGo);
    }
