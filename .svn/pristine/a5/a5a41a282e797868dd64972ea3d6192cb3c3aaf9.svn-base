...
public class ReverseJavaBytecodeParameters extends WizardParameters {
    ...
    private void loadProperties() {
        properties = PropertySet.getInstance(ReverseJavaBytecodeParameters.class);
    ...
    //projects
    public ReverseJavaBytecodeParameters() {
        loadProperties();
    }
