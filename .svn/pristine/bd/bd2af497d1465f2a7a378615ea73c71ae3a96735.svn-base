...
public class BEDescriptionModel extends ReflectionDescriptionModel {

    public BEDescriptionModel(ScreenView sv, DbObject parentObj, MetaClass metaClass,
            MetaRelationN[] listRelations) throws DbException {
        super(sv, parentObj, metaClass, listRelations);
    }

    public BEDescriptionModel(ScreenView sv, DbObject childObj,
