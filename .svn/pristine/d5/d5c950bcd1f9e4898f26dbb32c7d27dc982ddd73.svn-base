...
public class ReverseJavaBytecodeWizardPage1 extends WizardPage implements ActionListener,
        KeyListener {
    ...
    ReverseJavaBytecodeWizardPage1(Wizard<? extends WizardParameters> wizard) {
        super(wizard);

        properties = PropertySet.getInstance(ReverseJavaBytecodeWizardPage1.class);
    ...
    private void initContents() {
        ...
        //add label
        String title = LocaleMgr.misc.getString("ReverseEngineerClassAndJarFilesLabel");
        ...
        //add label
        title = LocaleMgr.misc.getString("ReverseEngineerClassesIntoLabel");
        ...
        newProjectBtn = new JRadioButton(LocaleMgr.misc.getString("NewProject"));
        existingProjectBtn = new JRadioButton(LocaleMgr.misc.getString("ExistingProject"));
    ...
    public void beforeShowing() {
        ...
        if (filename != null) {
            ...
            ReverseJavaBytecodeParameters params = (ReverseJavaBytecodeParameters) this.getWizard()
                    .getParameters();
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (src.equals(newProjectBtn)) {
            ...
            String chooserFolderText = LocaleMgr.misc.getString("ChooseFolder");
