 ...
 **********************************************************************/
// Possible Values : (no default values)
// MAP
// ORDER
...
public class ORAOrderingFunction extends IntDomain {
    ...
    public static final ORAOrderingFunction[] objectPossibleValues = new ORAOrderingFunction[] {
            new ORAOrderingFunction(MAP), new ORAOrderingFunction(ORDER) };

    public static final String[] stringPossibleValues = new String[] {
            LocaleMgr.misc.getString("map"), LocaleMgr.misc.getString("order") };

    public static ORAOrderingFunction getInstance(int value) {
        return objectPossibleValues[objectPossibleValues[0].indexOf(value)];
    }

    protected ORAOrderingFunction(int value) {
        super(value);
    }

    //Parameterless constructor
    public ORAOrderingFunction() {
    }

    public final DbtAbstract duplicate() {
        return new ORAOrderingFunction(value);
    }
