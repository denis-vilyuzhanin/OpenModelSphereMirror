...
/**
 * For a compilation unit, gets its package. <br>
 * Target System : <b>Java</b><br>
 * Type : <b>Connector</b><br>
 */

public final class CompilationunitPackage extends Connector.UserConnector {

    public Connector createInstance(String childRule, String oneChildRule) {
        Connector conn = new Connector(null, DbJVCompilationUnit.fComposite, childRule,
                new String[] { oneChildRule }, DbJVPackage.metaClass, new Modifier[] {});
        return conn;
    }

    public CompilationunitPackage() {
    } //Parameter-less constructor required by jack.io.Plugins

    //////////////////
    //OVERRIDES Plugin
    private static final PluginSignature g_signature = new CompilationunitPackageSignature();
    ...
    private static class CompilationunitPackageSignature extends PluginSignature {
        private static final String NAME = "CompilationunitPackage"; // NOT LOCALIZABLE
        ...
        public CompilationunitPackageSignature() {
