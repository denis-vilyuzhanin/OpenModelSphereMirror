...
package org.modelsphere.sms.be.screen.model;
...
public class BEListModel extends DbListModel {

    public BEListModel(ScreenView screenView, DbObject semObj, MetaRelationN[] listRelations,
    ...
    protected final ReflectionDescriptionModel createColumnDescriptionModel() throws DbException {
        return new BEDescriptionModel(screenView, semObj, listClass, listRelations);
    }

    protected final DescriptionModel createRowModel(DbObject dbObj) throws DbException {
        return new BEDescriptionModel(screenView, dbObj, columnModel);
    }
